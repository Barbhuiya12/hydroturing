...
| `reference_soil_heat` | exact | a synthetic fixed-layer fixture with conductive boundary fluxes and temperature integrated consistently | must pass `soil_heat_storage`; checks budget consistency, not temperature accuracy |
